  ...
  return (
    <HeaderFooterLayout>
      <div className="w-full bg-[#f4f7f9] pt-14 pb-0 px-4 sm:px-6 lg:px-8 font-sans antialiased">
        <div className="max-w-7xl mx-auto flex flex-col items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-5xl mb-14">
              ...
              <div className="w-full aspect-[16/10] max-w-[180px] flex items-center justify-center mb-4">
                ...
                >
                  ...
                  <ellipse
                    ...
                    rx="40"
                    ry="4"
                    className="text-sky-200/60 fill-current stroke-none"
                  />
                </svg>
              </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-slate-100 shadow-2xs flex flex-col items-center text-center">
              ...
              <div className="w-full aspect-[16/10] max-w-[180px] flex items-center justify-center mb-4">
                ...
                >
                  ...
                  <rect
                    ...
                    height="40"
                    rx="8"
                    className="fill-amber-100/70 text-amber-600"
                  />
                  <circle cx="48" cy="65" r="4" className="fill-amber-600" />
                  {/* Fish on Board */}
                  <path
                    d="M60 65c15-10 45-10 60 0c-15 10-45 10-60 0z"
                    className="fill-sky-100 text-sky-500"
                  />
                  {/* Knife Overlaid */}
                  <path
                    d="M140 35 L70 70 L80 78 L150 43 Z"
                    className="fill-rose-500 text-rose-600"
                  />
                  <line
                    x1="120"
                    y1="45"
              ...
              <p className="text-[11px] font-medium text-slate-500 leading-relaxed max-w-[220px]">
                We handpick the freshest catch, clean it thoroughly, and cut it
            ...
            <div className="bg-white rounded-2xl p-6 border border-slate-100 shadow-2xs flex flex-col items-center text-center">
              ...
              <div className="w-full aspect-[16/10] max-w-[180px] flex items-center justify-center mb-4">
                ...
                >
                  ...
                  <rect
                    ...
                    height="50"
                    rx="4"
                    className="fill-stone-50 text-stone-400"
                  />
                  <path
                    d="M130 45h25l15 15v25h-40Z"
                    className="fill-rose-500 text-rose-600"
                  />
                  ...
                  <text
                    x="55"
                    y="65"
                    className="font-black italic text-xs tracking-tighter stroke-none fill-slate-700"
                  >
                    Fishlo
                  </text>
                  {/* Wheels */}
                  <circle
                    ...
                    cy="85"
                    r="10"
                    className="fill-slate-800 text-stone-400"
                  />
                  <circle
                    cx="140"
                    cy="85"
              ...
              <p className="text-[11px] font-medium text-slate-500 leading-relaxed max-w-[220px]">
                Vacuum packed securely and delivered to your doorstep in our
                premium Fishlo box.
              </p>
            </div>
          </div>
        ...
        <div className="primary-bg-style p-5">
          <div className="text-xl font-extrabold  flex items-center justify-center gap-1">
            <span className="w-full bg-white/50 h-px"></span>
            <span className="w-full whitespace-nowrap">No Smell. No Mess. Just Fresh, Ready-to-Cook Fish.</span>
            <span className="w-full bg-white/50 h-px"></span>
          </div>
        </div>
