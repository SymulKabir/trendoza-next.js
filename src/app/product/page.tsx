        ...
        <div className="flex flex-wrap gap-2 mb-6">
          {categories.map((cat) => (
            <button
              ...
              className={`px-4 py-1.5 rounded-full text-xs font-semibold transition-all ${activeCategory === cat ? "bg-red-500 text-white" : "bg-slate-100 text-slate-600 hover:bg-slate-200"
                }`}
            >
              {cat}
            </button>
