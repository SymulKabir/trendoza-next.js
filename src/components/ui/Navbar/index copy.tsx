...
const Index = () => {
  ...
  return (
    <header className="bg-white min-h[60px] bg-[red] sticky top-0 z-50 primary-border primary-shadow">
      <div className="max-w-[1400px] mx-auto px-4 h-16 flex items-center justify-between">
        <div className="flex items-center gap-10">
          ...
          <button className="flex h-[50%] items-center gap-3 border-2 border-dashed border-gray-300 rounded-xl px-4 py-1 hover:border-[var(--primary-color)] transition-colors">
            <svg
